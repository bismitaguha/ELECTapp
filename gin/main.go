...
// Threads consist of all threads
type Threads struct {
	ID          int      `bson:"_id"`
...
// Candidates consist of all Candidates
...
// Comments is interface for binding json for comments
type Comments struct {
	Comment string `json:"comment"`
}

// PostComment helps to append comments
...
//PostThreads helps to add threads
...
//PostPinnedThreads inserts into pinned threads
...
// GetCandidateList gives list of all candidates
...
// GetPostedCandidateList gives list of candidates for a single post
...
// GetCandidate gives list of candidates for a single post
...
// GetForums gives list of all comments for particular candidate
...
// GetPinnedThreads gives list for all pinned threads for given users
...
func main() {
	...
	router.StaticFile("/modi.png", "modi.png")
	router.StaticFile("/obama.png", "obama.png")
